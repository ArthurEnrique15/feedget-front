...
export function FeedbackSuccessStep({ onRequestFeedbackRestart }: FeedbackSuccessStepProps) {
  return(
    <>
    <header>
      <CloseButton />
    ...
    {/* outra maneira de adicionar svg no react, sem precisar do arquivo */}
    ...
    <button
      ...
      className="py-2 px-6 mi-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
    >
      Quero enviar outro
    </button>
    </div>
